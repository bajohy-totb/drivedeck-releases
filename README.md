...
[**RC8 APK 다운로드**](https://github.com/bajohy-totb/drivedeck-releases/releases/download/v1.0.0-rc8/DriveDeck-1.0.0-rc8.apk) · [배포 기록](https://github.com/bajohy-totb/drivedeck-releases/releases) · [전체 사용 설명서](docs/guide.ko.md)

> **1.0.0-rc8은 시험판입니다.** 차량 음소거 시 멈춤, 연결 끊김, 반복 단독 실행 지연은 해결 확인 전입니다. 정식 1.0.0으로 표시하지 않습니다. 이전 RC7 검증에서는 화면 종료 중 약 6.8초 지연도 기록됐습니다.
...
| 앱 내 업데이트 | 새 시험판을 받고 Android 설치 화면에서 확인합니다. |
...
4. **설정 → 기기 → 업데이트 → 시험 버전 받기**를 켜고 새 버전을 확인합니다. RC7부터 앱 내 업데이트를 지원합니다.
5. 다운로드 후 설치를 누릅니다. Android에서 DriveDeck의 앱 설치 허용을 요청하면 허용 후 돌아와 설치를 다시 누릅니다.

![한국어 업데이트 화면](images/ko-updates.png)

자동 확인은 런처 실행·복귀 시 동작하며 마지막 확인 후 6시간 이내에는 건너뜁니다. 다운로드와 Android 설치 확인은 직접 진행합니다. 현재는 시험판만 배포하므로 정식 채널에는 새 버전이 없을 수 있습니다. 주차한 뒤 설치해 주세요.
...
- [시험판 검증 범위와 제한](docs/validation.md)

이 저장소는 **설치 파일·업데이트 안내·사용 설명서 배포용**입니다. 소스 코드와 서명 키는 포함하지 않습니다.
