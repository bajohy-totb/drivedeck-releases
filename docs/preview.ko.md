# DriveDeck 1.1.4 배율·서랍·조합 사용법

[한국어 소개](../README.md) · [English](preview.en.md) · [기본 사용법](guide.ko.md)

**정식 1.1.4**은 앱별 배율, 스크롤 앱 서랍, 직접 편집하는 홈 조합을 제공합니다. **홈 한 번 누르기 → 기본 홈, 길게 누르기 → 설정**입니다. 정식·시험 채널 모두 같은 1.1.4을 제공하며 기존 앱 위에 설치하면 설정을 유지합니다. 아래 이미지는 1.1.1-rc2 촬영본입니다.
